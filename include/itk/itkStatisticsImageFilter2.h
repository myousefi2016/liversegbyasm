 ...
 *
 *=========================================================================*/
#ifndef __itkStatisticsImageFilter2_h
#define __itkStatisticsImageFilter2_h
...
namespace itk
{
/** \class StatisticsImageFilter2
 * \brief Compute min. max, variance and mean of an Image.
 *
 * StatisticsImageFilter2 computes the minimum, maximum, sum, mean, variance
 ...
 *
 * \ingroup MathematicalStatisticsImageFilter2s
 * \ingroup ITKImageStatistics
 *
 * \wiki
 * \wikiexample{Statistics/StatisticsImageFilter2,Compute min\, max\, variance and mean of an Image.}
 * \endwiki
 */
template< class TInputImage >
class ITK_EXPORT StatisticsImageFilter2:
  public ImageToImageFilter< TInputImage, TInputImage >
{
public:
  /** Standard Self typedef */
  typedef StatisticsImageFilter2                          Self;
  ...
  itkTypeMacro(StatisticsImageFilter2, ImageToImageFilter);
  ...
  void SetThresholdLower(PixelType low){threLow = low;};
  void SetThresholdUpper(PixelType high){threHigh = high;};
...
private:
  StatisticsImageFilter2(const Self &); //purposely not implemented
...
#include "itkStatisticsImageFilter2.hxx"
#endif
