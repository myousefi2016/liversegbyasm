 ...
 *
 *=========================================================================*/
#ifndef __itkPointSetToImageMultipleValueMetric_h
#define __itkPointSetToImageMultipleValueMetric_h
...
namespace itk
{
/** \class PointSetToImageMultipleValueMetric
...
class ITK_EXPORT PointSetToImageMultipleValueMetric:public MultipleValuedCostFunction
{
public:
  /** Standard class typedefs. */
  typedef PointSetToImageMultipleValueMetric      Self;
  ...
  itkTypeMacro(PointSetToImageMultipleValueMetric, MultipleValuedCostFunction);
...
protected:
  PointSetToImageMultipleValueMetric();
  virtual ~PointSetToImageMultipleValueMetric() {}
...
private:
  PointSetToImageMultipleValueMetric(const Self &); //purposely not implemented
  void operator=(const Self &);        //purposely not implemented
};
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkPointSetToImageMultipleValueMetric.hxx"
#endif
