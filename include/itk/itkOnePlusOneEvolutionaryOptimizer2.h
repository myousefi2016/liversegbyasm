 ...
 *
 *=========================================================================*/
#ifndef __itkOnePlusOneEvolutionaryOptimizer2_h
#define __itkOnePlusOneEvolutionaryOptimizer2_h
...
public:
  ...
  itkSetMacro(CatchGetValueException, bool);
	...
	itkGetConstReferenceMacro(UseNumberOfCoefficient, int);
	itkSetMacro(UseNumberOfCoefficient, int);
...
private:
  ...
  double m_FrobeniusNorm;
	...
	int m_UseNumberOfCoefficient;
}; // end of class
} // end of namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkOnePlusOneEvolutionaryOptimizer.hxx"
#endif
