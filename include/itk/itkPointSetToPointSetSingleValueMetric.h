 ...
 *
 *=========================================================================*/
#ifndef __itkPointSetToPointSetSingleValueMetric_h
#define __itkPointSetToPointSetSingleValueMetric_h
...
namespace itk
{
/** \class PointSetToPointSetSingleValueMetric
...
class ITK_EXPORT PointSetToPointSetSingleValueMetric:public SingleValuedCostFunction
{
public:

  /** Standard class typedefs. */
  typedef PointSetToPointSetSingleValueMetric   Self;
  ...
  itkTypeMacro(PointSetToPointSetSingleValueMetric, SingleValuedCostFunction);
...
protected:
  PointSetToPointSetSingleValueMetric();
  virtual ~PointSetToPointSetSingleValueMetric() {}
...
private:
  PointSetToPointSetSingleValueMetric(const Self &); //purposely not implemented
  void operator=(const Self &);           //purposely not implemented
};
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkPointSetToPointSetSingleValueMetric.hxx"
#endif
