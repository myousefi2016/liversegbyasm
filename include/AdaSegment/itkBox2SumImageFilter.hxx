 ...
 *
 *=========================================================================*/
#ifndef __itkBox2SumImageFilter_hxx
#define __itkBox2SumImageFilter_hxx

#include "itkBox2SumImageFilter.h"
#include "itkProgressAccumulator.h"
#include "itkBox2Utilities.h"
...
Box2SumImageFilter< TInputImage, TOutputImage >
::Box2SumImageFilter()
{}
...
::ThreadedGenerateData(const OutputImageRegionType & outputRegionForThread, ThreadIdType threadId)
{
  ...
  Box2AccumulateFunction< TInputImage, AccumImageType >(inputImage, accImage,
                                                       accumRegion,
                                                       accumRegion,
                                                       progress);
  Box2SumCalculatorFunction< AccumImageType, TOutputImage >(accImage.GetPointer(), outputImage,
                                                            accumRegion,
