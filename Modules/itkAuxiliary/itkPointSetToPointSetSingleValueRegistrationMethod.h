 ...
 *
 *=========================================================================*/
#ifndef __itkPointSetToPointSetSingleValueRegistrationMethod_h
#define __itkPointSetToPointSetSingleValueRegistrationMethod_h
...
namespace itk
{
/** \class PointSetToPointSetSingleValueRegistrationMethod
...
class ITK_EXPORT PointSetToPointSetSingleValueRegistrationMethod:public ProcessObject
{
public:
  /** Standard class typedefs. */
  typedef PointSetToPointSetSingleValueRegistrationMethod Self;
  ...
  itkTypeMacro(PointSetToPointSetSingleValueRegistrationMethod, ProcessObject);
  ...
  /**  Type of the metric. */
  typedef SingleValuedPointSetToPointSetMetric<FixedPointSetType, MovingPointSetType> MetricType;
...
protected:
  PointSetToPointSetSingleValueRegistrationMethod();
  virtual ~PointSetToPointSetSingleValueRegistrationMethod() {}
...
private:
  PointSetToPointSetSingleValueRegistrationMethod(const Self &); //purposely not
                                                      // implemented
...
#include "itkPointSetToPointSetSingleValueRegistrationMethod.hxx"
#endif
