 ...
 *
 *=========================================================================*/
#ifndef __itkKMMattesMutualInformationImageToImageMetric_h
#define __itkKMMattesMutualInformationImageToImageMetric_h
...
public:
  ...
  typedef Image<ProbabilityPixelType, MovingImageType::ImageDimension>   ProbabilityImageType;
  typedef typename ProbabilityImageType::Pointer                         ProbabilityImagePointer;

  typedef LinearInterpolateImageFunction<ProbabilityImageType> FloatInterpolatorType;
  ...
  void SetProbabilityImage( ProbabilityImagePointer pImage );
...
private:
  ...
  mutable bool m_ImplicitDerivativesSecondPass;
	...
	MovingImageConstPointer m_MovingLabelImage;
  ProbabilityImagePointer m_ProbabilityImage;
  FloatInterpolatorPointer m_ProbabilityInterpolator;
  bool m_UseProbability;
	double m_LowerThreshold;
	double m_UpperThreshold;

	MovingImageConstPointer m_Tumor;
};
} // end namespace itk
