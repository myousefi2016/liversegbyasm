 ...
 *
 *=========================================================================*/
#ifndef __itkPointSetToImageMultipleValueRegistrationMethod_h
#define __itkPointSetToImageMultipleValueRegistrationMethod_h
...
namespace itk
{
/** \class PointSetToImageMultipleValueRegistrationMethod
...
class ITK_EXPORT PointSetToImageMultipleValueRegistrationMethod:public ProcessObject
{
public:
  /** Standard class typedefs. */
  typedef PointSetToImageMultipleValueRegistrationMethod Self;
  ...
  itkTypeMacro(PointSetToImageMultipleValueRegistrationMethod, ProcessObject);
  ...
  /**  Type of the metric. */
  typedef PointSetToImageMultipleValueMetric< FixedPointSetType, MovingImageType > MetricType;
  ...
  typedef   MultipleValuedNonLinearVnlOptimizer OptimizerType;
...
protected:
  PointSetToImageMultipleValueRegistrationMethod();
  virtual ~PointSetToImageMultipleValueRegistrationMethod() {}
...
private:
  PointSetToImageMultipleValueRegistrationMethod(const Self &); //purposely not implemented
...
#include "itkPointSetToImageMultipleValueRegistrationMethod.hxx"
#endif
