...
*
*=========================================================================*/
#ifndef __itkMinValuePointSetToImageMetric_h
#define __itkMinValuePointSetToImageMetric_h
...
namespace itk
{
	/** \class MinValuePointSetToImageMetric
	...
	*/
	...
	class ITK_EXPORT MinValuePointSetToImageMetric:
		public PointSetToImageMetric< TFixedPointSet, TMovingImage >
	{
	public:

		/** Standard class typedefs. */
		typedef MinValuePointSetToImageMetric                   Self;
		...
		itkTypeMacro(MinValuePointSetToImageMetric, Object);
	...
	protected:
		...
		virtual ~MinValuePointSetToImageMetric();

		/** PrintSelf function */
		void PrintSelf(std::ostream & os, Indent indent) const;

	private:
		MinValuePointSetToImageMetric(const Self &); //purposely not implemented
		...
		PointType          m_MovingImageCenter;
	};
} // end namespace itk

#ifndef ITK_MANUAL_INSTANTIATION
#include "itkMinValuePointSetToImageMetric.hxx"
#endif
