...
public:
  ...
  typedef          itk::TriangleCell< SimplexCellType > SimplexTriangleType;
...
public:
     ...
     */
    void Visit(CellIdentifier cellId, SimplexCellType *poly)
    {
...
protected:
  ...
  typedef itk::CellInterfaceVisitorImplementation< InputPixelType,
                                                   ...
                                                   SimplexPolygonType,
                                                   SimplexCellVisitor >
  SimplexPolygonVisitorInterfaceType;

  typedef itk::CellInterfaceVisitorImplementation< InputPixelType,
                                                   InputCellTraitsType,
                                                   SimplexTriangleType,
                                                   SimplexCellVisitor >
  SimplexTriangleVisitorInterfaceType;

  typedef typename SimplexPolygonVisitorInterfaceType::Pointer SimplexPolygonVisitorInterfacePointer;
  typedef typename SimplexTriangleVisitorInterfaceType::Pointer SimplexTriangleVisitorInterfacePointer;
...
#include "itkSimplexMeshToTriangleMeshFilter2.hxx"
#endif
